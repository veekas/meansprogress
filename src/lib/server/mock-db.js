...
export function createMockDb() {
  ...
  /** @type {Array<{ id: string, title: string, embed_url: string, height: number, note: string, created_at: string }>} */
  const music_posts = [
    {
      id: id(),
      title: "july26",
      embed_url:
        "https://embed.music.apple.com/us/playlist/july26/pl.u-WabZdMaUvjE84r",
      height: 450,
      note: "songs i'm repeating this month",
      created_at: now(),
    },
  ];
  ...
  const storage = new Map([
    [photoPath, { contentType: "image/svg+xml", url: PLACEHOLDER_PHOTO }],
  ]);
